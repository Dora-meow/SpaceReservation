...
1. 登入系統（登入後才能借用，否則只能看到登入跟註冊頁面）[4](https://github.com/Dora-meow/SpaceReservation/edit/main/README.md#%E7%99%BB%E5%85%A5%E7%B3%BB%E7%B5%B1)
...
* 註冊帳號
  </br>註冊成功後會跳到登入頁面 (勾選 `管理員` 登入後才會出現管理員的功能選單)
